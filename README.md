...
| 03 | [Regras de negócio](docs/04-regras-de-negócio.md) | Restrições e comportamentos que orientam o sistema. |
| 04 | [Casos de uso](docs/03-casos-de-uso.md) | Ações de atores, entradas, saídas, regras e exceções. |
